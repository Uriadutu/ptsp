...
const AddSuratMasukModal = ({ setIsOpenModalAdd, getSuratMasukBySub }) => {
  ...
  const tambahSurat = async (e) => {
    ...
    try {
      await axios.post("http://192.168.85.20:3005/suratmasuk", formData, {
        headers: {
...
export default AddSuratMasukModal;
