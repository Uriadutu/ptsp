...
const AddLembagaKeagamaanModal = ({ setIsOpenModalAdd, getLembagaKeagamaan }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("http://192.168.85.20:3005/lembaga-keagamaan", {
        nama_lembaga: namaLembaga,
        alamat: alamat,
        tahun_berdiri: tahunBerdiri,
        nama_pimpinan: namaPimpinan,
        tahun_periode: tahunPeriode,
        jumlah_bidang: jumlahBidang,
          ...
          <div className="p-4 space-y-4 inline-block ">
            <div className="mb-6">
              <div className="grid grid-cols-2 gap-5 mb-2">
                <label htmlFor="namaLembaga" className="label-input">
                  Nama Lembaga
                </label>
                <input
                  id="namaLembaga"
              ...
              <div className="grid grid-cols-2 gap-5 mb-2">
                <label htmlFor="jumlahBidang" className="label-input">
                  Jumlah Bidang
                </label>
                <input
                  id="jumlahBidang"
...
export default AddLembagaKeagamaanModal;
