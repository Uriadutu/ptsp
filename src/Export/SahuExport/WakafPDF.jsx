...
const WakafPDF = React.forwardRef(({ wakaf }, ref) => {
  return (
    <div ref={ref} className="py-3 pl-4 pr-3 mx-5 mt-10">
      ...
      <h1 className="text-center mb-2">DATA TANAH WAKAF</h1>
      <div className="mt-4">
          ...
          {wakaf.map((item, index) => (
            <React.Fragment key={index}>
              <tr>
                ...
                <td className="border border-gray-300 p-2 text-left">
                  {item && item.jenis_tanah}
                </td>
                <td className="border border-gray-300 p-2 text-left">
                  {item && item.luas_tanah}
                </td>
                <td className="border border-gray-300 p-2 text-left">
                  {item && item.jumlah_wakaf}
                </td>
              </tr>
            </React.Fragment>
          ))}
